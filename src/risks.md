...
- Восстановление из резервной копии при потере данных — RPO не более 15 минут (streaming replication + инкрементальный бэкап каждые 15 мин).
