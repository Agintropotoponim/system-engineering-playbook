...
- Подрядчик пытается открыть обращение другого подрядчика — система возвращает 403
...
Оператор должен обрабатывать некорректные, спорные, требующие вмешательства обращения.
...
7. Может переназначить обращение подрядчику вручную.
...
6. Аналитик формирует отчет по выбранным параметрам.
7. Система сохраняет или экспортирует отчет.
8. Полученные данные используются для контроля качества работы и подготовки управленческих решений.
