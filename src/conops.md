...
- [Входит в систему](#21-входит-в-систему)
- [Внешние зависимости](#22-внешние-зависимости)
- [Что не входит в систему](#23-что-не-входит-в-систему)

## 3. [Операционные роли](#3-Операционные-роли)

- [Гражданин](#31-гражданин)
- [Оператор](#32-оператор)
- [Подрядчик](#33-подрядчик)
- [Администратор](#34-администратор)
- [Аналитик](#35-аналитик)
- [Служба поддержки](#36-служба-поддержки)

## 4. [Операционные сценарии](#4-Операционные-сценарии)

- [Сценарий 1. Подача обращения гражданином](#41-подача-обращения-гражданином)
- [Сценарий 2. Автоматическая маршрутизация обращения](#42-автоматическая-маршрутизация-обращения)
- [Сценарий 3. Выполнение работ подрядчиком](#43-выполнение-работ-подрядчиком)
- [Сценарий 4. Ручная обработка оператором](#44-ручная-обработка-оператором)
- [Сценарий 5. Анализ обращений и формирование отчетности](#45-анализ-обращений-и-формирование-отчетности)
